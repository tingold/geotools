 ...
 * <p>
 * Barnes Surface Interpolation is a surface estimating technique 
 ...
 * based on its proximity to the points in the input observations.
 * Further refinement passes may be computed to improve the surface estimate 
 * to more closely approximate the observed values.
 * <ul>
 ...
 * where
 * <ul>
 * <li>Eg is the estimated surface value at the grid cell
 * <li>wi is the weight value for the i'th observation point (see below for definition)
 * <li>oi is the value of the i'th observation point
 * </ul>
 * <p>
 * The weight (decay) function used is:
 * 
 * <pre>
 * wi = exp(-di<sup>2</sup> / L<sup>2</sup>c )
 * </pre>
 * 
 * where:
 * <ul>
 * <li>wi is the <b>weight</b> of the i'th observation point value
 * <li>di is the <b>distance</b> from the grid cell being estimated to the i'th observation point
 * <li>L is the <b>length scale</b>, which is determined by the observation spacing 
 ...
 * <li>c is the <b>convergence factor</b>, which controls how much refinement takes place during each refinement step. 
